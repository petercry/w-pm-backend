 ...
 * @since 2022-06-21
 */
public class WProjectContractQueryer extends AbstractModuleQuery<WProjectInfoMapper, WProjectInfoDTO, WProjectInfoDO> implements IWProjectContractQuery,BaseQuery<WProjectInfoDO> {
